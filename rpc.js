...
class NexelliaInterface {
    ...
    async main() {
        ...
        const methods = proto.NexelliadMessage.type.field
        ...
        program
            ...
            .description(`Nexellia gRPC client ${pkg.version}`)
...
Please run ${'nexellia-rpc help'.yellow} for addition information and examples.        
        `)
        ...
        program
            ...
            .action(async (cmd, options) => {
                ...
                console.log('');
                console.log(`Nexellia gRPC client ${pkg.version}`);
                console.log('');
...
Examples:
    ...
    $ ${`rpc --verbose getUtxosByAddresses --addresses=[\\"nexelliatest:qru9nrs0mjcrfnl7rpxhhe33l3sxzgrc3ypkvkx57u\\"]`.yellow}
    ...
    Where file.js can contain: ${`{ addresses : ['nexelliatest:qru9nrs0mjcrfnl7rpxhhe33l3sxzgrc3ypkvkx57u'] }`.yellow}
...
(async()=>{
    const ki = new NexelliaInterface();
    await ki.main();
})();
